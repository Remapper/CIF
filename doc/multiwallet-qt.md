...
Only requiring some minor changes is cif.cpp.
...
Changes to cif.cpp
----------------------
cif.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
