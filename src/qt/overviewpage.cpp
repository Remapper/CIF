...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(BitcoinUnits::CIF)
    {
    ...
    if(fLiteMode){
        ...
        if(fMasterNode){
            ...
            if(!fEnablePrivateSend){
                ui->togglePrivateSend->setText(tr("Start PrivateSend Mixing"));
            } else {
                ui->togglePrivateSend->setText(tr("Stop PrivateSend Mixing"));
            }
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    if(currentBalance == 0)
    {
        ...
        strAmountAndRounds = strAnonymizeDarkcoinAmount + " / " + tr("%n Rounds", "", nPrivateSendRounds);
