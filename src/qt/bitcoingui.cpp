...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CIF Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CIF"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the CIF Core help message to get a list with possible CIF command-line options"));
