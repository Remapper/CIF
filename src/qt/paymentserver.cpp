...
const char* BIP71_MIMETYPE_PAYMENT = "application/cif-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/cif-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/cif-paymentrequest";
...
//
// OSX-specific way of handling cif: URIs and
// PaymentRequest mime types
//
bool PaymentServer::eventFilter(QObject *object, QEvent *event)
{
    // clicking on cif: URIs creates FileOpen events on the Mac
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    foreach(const PAIRTYPE(CScript, CAmount)& sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom cif addresses are not supported
