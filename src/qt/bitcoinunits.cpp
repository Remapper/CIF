...
QString BitcoinUnits::id(int unit)
{
    switch(unit)
    {
        ...
        case uCIF: return QString::fromUtf8("ucif");
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkID() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case duffs: return QString("Ten Nano-CIF (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            ...
            case duffs: return QString("Ten Nano-TestCIF (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
