...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* CIF features */
    { "cif",               "masternode",             &masternode,             true,      true,       false },
    { "cif",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "cif",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "cif",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "cif",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "cif",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "cif",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "cif",               "privatesend",               &privatesend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use cifd, or the -server option to cif-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
