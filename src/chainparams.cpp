...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        (  0, uint256("0x541c4ea50d48edfbf97b390abda8f0968967a3395255b07975a3338914cb40b0"))
...
public:
    CMainParams() {
        ...
        nDefaultPort = 43199;
        bnProofOfWorkLimit = ~uint256(0) >> 20;  // CIF starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nEnforceBlockUpgradeMajority = 750;
        nRejectBlockOutdatedMajority = 950;
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 0;
        nTargetTimespan = 10 * 24 * 60 * 60; // CIF: 1 day
        nTargetSpacing = 2 * 60; // CIF: 2.5 minutes
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1513801232;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 2189284;
...
const int SCRYPT_SCRATCHPAD_SIZE = 131072 + 63;
        ...
        assert(hashGenesisBlock == uint256("0x2f410836673a0bf23369b00cbda395585221ab615fbf8ff3ae2774287a7b72c1"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of( 28);                    // CIF addresses start with 'C'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 16);                    // CIF script addresses start with '7'
        base58Prefixes[SECRET_KEY] =     list_of(204);                    // CIF private keys start with '7' or 'X'
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x02)(0xFE)(0x52)(0xF8); // CIF BIP32 pubkeys start with 'drkv'
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x02)(0xFE)(0x52)(0xCC); // CIF BIP32 prvkeys start with 'drkp'
        base58Prefixes[EXT_COIN_TYPE]  = list_of(0x80000005);             // CIF BIP44 coin type is '5'
        ...
        strPrivateSendPoolDummyAddress = "Xq19GqFvajRrEdDHYRKGYjTsQfpV5jyipF";
...
public:
    CTestNetParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // CIF: 1 day
        nTargetSpacing = 2.5 * 60; // CIF: 2.5 minutes
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        /*vSeeds.push_back(CDNSSeedData("cifpay.io", "testnet-seed.cifpay.io"));
        vSeeds.push_back(CDNSSeedData("cif.qa", "testnet-seed.cif.qa"));
        *///legacy seeders
        vSeeds.push_back(CDNSSeedData("darkcoin.io",  "testnet-seed.darkcoin.io"));
        vSeeds.push_back(CDNSSeedData("darkcoin.qa", "testnet-seed.darkcoin.qa"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of(139);                    // Testnet cif addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 19);                    // Testnet cif script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY]     = list_of(239);                    // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x3a)(0x80)(0x61)(0xa0); // Testnet cif BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x3a)(0x80)(0x58)(0x37); // Testnet cif BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_COIN_TYPE]  = list_of(0x80000001);             // Testnet cif BIP44 coin type is '5' (All coin's testnet default)
        ...
        strPrivateSendPoolDummyAddress = "y1EZuxhhNMAUofTBEeLqGE1bJrpC2TWRNp";
