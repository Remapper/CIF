...
static const int64_t PrivateSend_COLLATERAL = (0.01*COIN);
static const int64_t PrivateSend_POOL_MAX = (999.99*COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 1000 CIF - checking if valid masternode)
...
public:
    ...
    void SendPrivateSendDenominate(std::vector<CTxIn>& vin, std::vector<CTxOut>& vout, int64_t amount);
