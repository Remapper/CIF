...
RESOURCES += src/qt/cif.qrc src/qt/cif_locale.qrc
TRANSLATIONS += src/qt/locale/cif_bg.ts \
                src/qt/locale/cif_de.ts \
                src/qt/locale/cif_en.ts \
                src/qt/locale/cif_es.ts \
                src/qt/locale/cif_fi.ts \
                src/qt/locale/cif_fr.ts \
                src/qt/locale/cif_it.ts \
                src/qt/locale/cif_ja.ts \
                src/qt/locale/cif_pl.ts \
                src/qt/locale/cif_pt.ts \
                src/qt/locale/cif_ru.ts \
                src/qt/locale/cif_sk.ts \
                src/qt/locale/cif_sv.ts \
                src/qt/locale/cif_vi.ts \
                src/qt/locale/cif_zh_CN.ts \
                src/qt/locale/cif_zh_TW.ts
